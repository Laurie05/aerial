...
export const techniques: Technique[] = [
  ...
  {
    id: "hammock-straddle",
    name: "Hammock Straddle",
    aliases: ["straddle on hammock"],
    apparatus: ["hammock"],
    category: "poses",
    difficulty: "beginner",
    description:
  ...
  // =============================================
  // ROPE TECHNIQUES (silks without split silk)
  // =============================================
  {
    id: "rope-hip-key",
    name: "Rope Hip Key",
